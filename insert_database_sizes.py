...
def insert_database_sizes(target_server, target_username, target_password, dba_username, dba_password):
    """
...
if __name__ == "__main__":
    ...
    insert_database_sizes(args.target_server, args.target_username, args.target_password, args.dba_username, args.dba_password)
